...
export const searchCommandDefinition = {
    ...
    action: async (interaction) => {
        ...
        const embed = new MessageEmbed()
            ...
            .setFields({ name: "Project Type", value: `${hits[0].project_type}` }, { name: "Author", value: `${hits[0].author}` }, { name: "Downloads", value: `${hits[0].downloads}` }, { name: "Last Updated", value: `${hits[0].date_modified}` }, { name: "Project ID", value: `${hits[0].project_id}` });
